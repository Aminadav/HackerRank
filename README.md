...
- Solution - [print-the-elements-of-a-linked-list.js](print-the-elements-of-a-linked-list.js)
...
- Solution - [insert-a-node-at-the-tail-of-a-linked-list.js](insert-a-node-at-the-tail-of-a-linked-list.js)
...
- Solution - [insert-a-node-at-the-head-of-a-linked-list.js](insert-a-node-at-the-head-of-a-linked-list.js)
...
- Solution - [insert-a-node-at-a-specific-position-in-a-linked-list.js](insert-a-node-at-a-specific-position-in-a-linked-list.js)

#### Linked List: Delete A Node [JavaScript]

- Problem - https://www.hackerrank.com/challenges/delete-a-node-from-a-linked-list
- Solution - [delete-a-node-from-a-linked-list.js](delete-a-node-from-a-linked-list.js)
...
- Solution - [print-the-elements-of-a-linked-list-in-reverse.js](print-the-elements-of-a-linked-list-in-reverse.js)

#### Linked List: Reverse [JavaScript]

- Problem - https://www.hackerrank.com/challenges/reverse-a-linked-list
- Solution - [reverse-a-linked-list.js](reverse-a-linked-list.js)

#### Linked List: Compare [JavaScript]

- Problem - https://www.hackerrank.com/challenges/compare-two-linked-lists
- Solution - [compare-two-linked-lists.js](compare-two-linked-lists.js)
...
- Solution - [merge-two-sorted-linked-lists.js](merge-two-sorted-linked-lists.js)
...
- Solution [get-the-value-of-the-node-at-a-specific-position-from-the-tail.js](get-the-value-of-the-node-at-a-specific-position-from-the-tail.js)
...
- Solution - [delete-duplicate-value-nodes-from-a-sorted-linked-list.js](delete-duplicate-value-nodes-from-a-sorted-linked-list.js)
...
- Solution - [detect-whether-a-linked-list-contains-a-cycle.cpp](detect-whether-a-linked-list-contains-a-cycle.cpp)
...
- Solution - [find-the-merge-point-of-two-joined-linked-lists.cpp](find-the-merge-point-of-two-joined-linked-lists.cpp)
...
- Solution -[insert-a-node-into-a-sorted-doubly-linked-list.js](insert-a-node-into-a-sorted-doubly-linked-list.js)

#### Doubly Linked List: Reverse [Python]

- Problem - https://www.hackerrank.com/challenges/reverse-a-doubly-linked-list
- Solution - [reverse-a-doubly-linked-list.js](reverse-a-doubly-linked-list.js)
